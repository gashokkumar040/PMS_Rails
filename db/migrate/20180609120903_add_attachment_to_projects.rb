class AddAttachmentToProjects < ActiveRecord::Migration[5.2]
  ...
  def self.down
    remove_column :projects, :attachment_file_name
    remove_column :projects, :attachment_content_type
    remove_column :projects, :attachment_file_size 
    remove_column :projects, :attachment_updated_at
  end
end
